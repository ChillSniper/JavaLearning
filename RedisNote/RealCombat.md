...
![alt text](../pictures/image-5_4.png)

项目架构：

![alt text](../pictures/image-6_3.png)
...
![alt text](../pictures/image-7_4.png)

**Session**，即**会话**。这个会话在服务器端是一个存储空间，与浏览器进行绑定，通过**Session ID**区分不同用户

![alt text](../pictures/image-8_4.png)

注意这个**拦截器**

### 集群的session共享问题

![alt text](../pictures/image-9_4.png)
...
![alt text](../pictures/image-10_3.png)

这个**token**，在注册的时候会返回给前端（客户端），然后前端会获取到token在**Redis**中对应存储的信息

这边这个token得用随机字符串，不能用手机号，不然在前端里面会有泄漏的风险

![alt text](../pictures/image-11_2.png)

对于**登录拦截器**的优化

![alt text](../pictures/image-12_3.png)

## 商户查询缓存

![alt text](../pictures/image-13_3.png)
...
![alt text](../pictures/image-14_3.png)
...
![alt text](../pictures/image-15_3.png)
...
![alt text](../pictures/image-16_3.png)

低一致性需求：使用内存淘汰机制，比如店铺类型的查询缓存
高一致性需求：主动更新，并且用超时剔除作为兜底方案，比如店铺详情查询的缓存

![alt text](../pictures/image-17_2.png)

第三个方案是**异步**机制

而方案一是开发者自行编码的，可控性较高

![alt text](../pictures/image-19_3.png)

我们应当**删除缓存**，而不是更新缓存

![alt text](../pictures/image-18_3.png)
...
![alt text](../pictures/image-20_3.png)
...
![alt text](../pictures/image-21_2.png)
2. 布隆过滤
...
- 实现非常复杂
- 存在误判可能
![alt text](../pictures/image-22_2.png)
...
![alt text](../pictures/image-23_2.png)
...
![alt text](../pictures/image-24_2.png)

注意：**逻辑过期**不会把数据踢掉

**互斥锁**方案有**死锁**风险

![alt text](../pictures/image-25_2.png)
...
![alt text](../pictures/image-26_1.png)

### 基于逻辑过期方式解决缓存击穿问题

![alt text](../pictures/image-27_2.png)
...
![alt text](../pictures/image-28_2.png)
...
![alt text](../pictures/image-29_2.png)
...
![alt text](../pictures/image-30_2.png)

线程并发产生的安全问题

常见解决方案：**加锁！**

![alt text](../pictures/image-31_2.png)
...
![alt text](../pictures/image-32_2.png)
...
![alt text](../pictures/image-33_2.png)

这就是所谓的**分布式锁**

分布式锁：满足分布式系统或者集群模式下**多进程可见**并且**互斥**的锁

![alt text](../pictures/image-34_1.png)

### 分布式锁的实现

>这个**Zookeeper**是什么东西

![alt text](../pictures/image-35_2.png)
...
实现分布式锁的两个基本方法：
![alt text](../pictures/image-36_1.png)

![alt text](../pictures/image-37_1.png)

### 基于Redis的分布式锁

这边讲的一个**Redis分布式锁误删**案例非常有意思

![alt text](../pictures/image-38_1.png)

问题出在业务阻塞的线程1上，锁既被提前释放，又被**del**删除

解决方案：

![alt text](../pictures/image-39_1.png)
...
![alt text](../pictures/image-41_1.png)
...
![alt text](../pictures/image-42_1.png)
...
![alt text](../pictures/image-43_1.png)
